<template>
  <div class="bg-[#F7F8FC] md:p-5 w-full">
    <div class="bg-white md:p-4 rounded-lg mb-5">
      <div>
        <div class="bg-white m-6 md:m-4 rounded-lg md:p-8">
...
const onSubmit = async () => {
 ...
 formData.append('contacts', JSON.stringify(savedLinks.value));
